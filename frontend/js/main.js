...
{
    $.getJSON("/search.php", contactInfo,function(data) 
    {
        var retrieveContact = 
    });
...
//        var contact[];
//        $.each(contactInfo, function(key, val)
//        {
//            contact.push("<tr>");
//            contact.push("<td id='' "+key+" ''> "+val.name+" </td>");
//            
//            contact.push(
//                "<td id='"+key+"' onClick=loadContact();'> "+val.name" </td>");
//            
//            
//            contact.push("<td id='"+key+" ''> "+val.address+" </td>");
//            contact.push("</tr>");
//        });
